using ApiCatalogoJogos_Rafael.Controllers.V1;
using ApiCatalogoJogos_Rafael.Repositories;
using ApiCatalogoJogos_Rafael.Service;
...
namespace ApiCatalogoJogos_Rafael
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "ApiCatalogoJogos_Rafael v1"));
            }
