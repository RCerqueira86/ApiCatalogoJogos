using ApiCatalogoJogos_Rafael.Exceptions;
...
namespace ApiCatalogoJogos_Rafael.Controllers.V1
{
    ...
    public class JogosController : ControllerBase
    {
        ...
        /// <response code="200">Caso o preço seja excluído com sucesso</response>
        /// <response code="404">Caso não exista um jogo com este Id</response>   
